...
# Form implementation generated from reading ui file 'Boss_1_MiddleMode.ui'
#
...
"}")
    ...
    def retranslateUi(self, Boss_1_HardMode):
        ...
        Boss_1_HardMode.setWindowTitle(_translate("Boss_1_HardMode", "MainWindow"))
        self.label_boss_hp.setText(_translate("Boss_1_HardMode", "BOSS HP - "))
        self.pushButton.setText(_translate("Boss_1_HardMode", "Ударить"))
        self.label_boss_dmg.setText(_translate("Boss_1_HardMode", "Вы напали на босса"))
        self.label_money.setText(_translate("Boss_1_HardMode", "MONEY - "))
        self.label_hp.setText(_translate("Boss_1_HardMode", "HP -"))
